...
datasetname = 'rnd-1000_1000'
ckptname = 'rnd_pyramid_iter1'
testpath = './Cell_gen/val/'+datasetname+'/input'
testpath = 'E:/Thesis/BNL/Deblurring/MyCode/result/rnd_pyramid/rnd-1000_1000/img'
...
for i,data in enumerate(val_loader,0):
    ...
    with torch.no_grad():
        ...
        ckptpath = './deblur_mask_ckpt/'+ckptname+'/cell_model_e49.pkl'
    ...
    cv.imwrite("./result/"+ckptname+'/'+datasetname+"/img/"+imgs[i],output_cpu*255)
