...
data_dir = './Cell_gen/v5/cond1_256real/input'
gt_dir = './Cell_gen/v5/cond1_256real/gt'
mask_dir = './Cell_gen/v5/cond1_256real/mask'
val_dir = './Cell_gen/v5/cond1val_256real/input'
valgt_dir = './Cell_gen/v5/cond1val_256real/gt'
...
for epoch in range(50):
    ...
    model_path = "./deblur_mask_ckpt/cond1_256real/e"+str(epoch)+".pkl"
